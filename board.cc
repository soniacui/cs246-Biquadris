    ...
    if (tetroInfo.isHeavy || tetroInfo.speed != 0) {
		...
		if (tetroInfo.absCoords[i][1] - 1 < 0)
		    ...
		    bool hasLower = false;
                ...
                return !hasLower; //since there is no free space under a pixel of the tetromino, and it isn't itself, it has dropped
            }
        }
        return false;
    }
