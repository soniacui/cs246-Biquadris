...
unique_ptr<BoardInfo> Board::getInfo() const {
    ...
    unique_ptr<BoardInfo> bInfo{ new BoardInfo(displayGrid, currPunish, playerID, deletedRow, nextTetro, isTurn, menu, hasLost, "board") };
    return bInfo;
}
